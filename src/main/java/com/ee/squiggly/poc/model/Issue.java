...
public class Issue extends ResourceSupport {
    ...
    private static Issue buildIssue1() {
        ...
        issue.setActions(Arrays.asList(new IssueAction("COMMENT", "I'm going to let Daario get this one..", assignee),
    ...
    private static Issue buildIssue2() {
        ...
        issue.setActions(Collections.singletonList(new IssueAction("COMMENT", "Ugh.  Do have to?", assignee)));
        issue.setProperties(properties);
        return issue;
    }
    ...
    private static Issue buildIssue3() {
        ...
        issue.setActions(Collections.singletonList(new IssueAction("CLOSE", "Your wish is my command.", assignee)));
        issue.setProperties(properties);
        return issue;
    }
